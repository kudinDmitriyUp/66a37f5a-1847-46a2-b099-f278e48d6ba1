...
export const metadata: Metadata = {
  title: "AI Studio - Intelligent Automation for Modern Business",
  description: "Transform your business with AI-powered automation and analytics. Streamline workflows, gain insights, and unlock growth.",
  keywords: "AI automation, machine learning platform, business intelligence, workflow automation, SaaS",
  metadataBase: new URL("https://aistudio.com"),
  alternates: {
    canonical: "https://aistudio.com"
  },
  openGraph: {
    title: "AI Studio - Intelligent Automation Platform",
    description: "Harness AI to automate workflows and gain powerful business insights.",
    type: "website",
    siteName: "AI Studio",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763921691876-j2p4ave0.jpg",
        alt: "AI Studio Platform"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "AI Studio - Intelligent Automation",
    description: "Transform your business with AI-powered automation and analytics.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763921691876-j2p4ave0.jpg"]
  },
  robots: {
    index: true,
    follow: true
